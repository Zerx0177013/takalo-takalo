    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="<?= BASE_URL ?>/"><img src="<?= BASE_URL ?>/assets/images/logo.svg" alt="Takalo logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="<?= BASE_URL ?>/"><img src="<?= BASE_URL ?>/assets/images/logo-mini.svg" alt="Takalo logo mini" /></a>
        </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="mt-4">
                      ...
                      <p class="text-muted"><?= nl2br(htmlspecialchars($item['description'] ?? 'Aucune description disponible')) ?></p>
                    </div>

                    <?php if (!empty($images)): ?>
                    <div class="mt-4">
                      <h4 class="mb-3"><i class="mdi mdi-image-multiple"></i> Photos de l'objet (<?= count($images) ?>)</h4>
