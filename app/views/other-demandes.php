...
<head>
    ...
    <title>Demandes Reçues - Takalo-Takalo</title>
...
<body>
   ...
   ?>
    ...
    <script>
        ...
        function handleDemande(demandeId, action) {
            const actionText = action === 'accept' ? 'accepter' : 'refuser';
            const confirmText = `Êtes-vous sûr de vouloir ${actionText} cette demande d'échange ?`;
